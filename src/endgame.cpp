...
template<>
Value Endgame<KK>::operator()(const Position& pos) const {
    return VALUE_DRAW;
}
template<>
Value Endgame<KBK>::operator()(const Position& pos) const {
    return VALUE_DRAW;
}
template<>
Value Endgame<KNK>::operator()(const Position& pos) const {
    return VALUE_DRAW;
}
#endif
